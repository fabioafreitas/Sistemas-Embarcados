...
const char* ssid = "BBG_JOSELITO";            //SSID da rede WIFI
const char* password =  "Singularidade10";    //senha da rede wifi
 
//informações do broker MQTT - Verifique as informações geradas pelo CloudMQTT
const char* mqttServer = "4.tcp.ngrok.io";    //server
const char* mqttUser = "fabio";               //user
const char* mqttPassword = "fabio123";        //password
const int mqttPort = 11644;                   //port
const char* mqttTopicSub ="test";             //tópico que sera assinado
...
void reconect() {
  ...
  while (!client.connected()) {
    ...
    if(conectado) {
      ...
      #endif
      //subscreve no tópico
      client.publish(mqttTopicSub, "FabioTeste");
